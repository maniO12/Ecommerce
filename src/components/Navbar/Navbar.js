...
import WhatsApp  from '../Assets/WhatsApp Image 2024-10-10 at 21.14.13_a5e7f322.jpg';
    ...
    <nav className="navbar navbar-expand-lg navbar-light bg-light ">
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
        <ul className="navbar-nav mx-auto custom-nav">
          ...
          <li className="nav-item">
            <Link to="/Personalize" className="nav-link" onClick={() => setMenu('personalize')}>
              Personalize {menu === 'personalize' && <hr className="hr1" />}
            </Link>
            </li>
        </ul>
